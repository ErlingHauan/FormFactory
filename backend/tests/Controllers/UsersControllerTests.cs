...
public class UsersControllerTests
{
    ...
    public async Task Get_ReturnsFoundUser()
    {
        ...
        _mockRepo.Setup(repo => repo.GetSingle(1)).ReturnsAsync(mockUsers.First(u => u.Id == 1));
    ...
    {
        // Arrange
        _mockRepo.Setup(repo => repo.GetSingle(1)).ReturnsAsync((UserEntity?)null);
    ...
    public async Task Delete_ReturnsOk()
    {
        ...
        _mockRepo.Setup(repo => repo.GetSingle(userToBeDeleted.Id)).ReturnsAsync(userToBeDeleted);
    ...
    public async Task Delete_ReturnsNotFound()
    {
        // Arrange
        var userId = 1;
        _mockRepo.Setup(repo => repo.GetSingle(userId)).ReturnsAsync((UserEntity?)null);
